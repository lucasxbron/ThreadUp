...
export const PasswordInput: React.FC<PasswordInputProps> = ({
  ...
  return (
    <div className="space-y-1">
      {label && (
        <label className="block text-sm font-medium" style={{ color: 'var(--color-foreground, #0f172a)' }}>
          {label}
        </label>
      )}
      <div className="relative">
        <input
          ...
          style={{
            ...
            borderColor: error ? 'var(--color-destructive, #ef4444)' : 'var(--color-border, #e2e8f0)'
          }}
          {...props}
        />
        <button
