        ...
        <div className="flex space-x-3">
          ...
          <div className="flex-1">
            <form onSubmit={handleSubmit} className="space-y-4">
              {/* Custom styled textarea with visible border */}
              <div 
                ...
                style={{ 
                  ...
                  border: `1px solid ${isFocused ? 'var(--color-primary, #3b82f6)' : 'var(--color-border, #e2e8f0)'}`,
              ...
              >
                <textarea
                  ...
                  rows={3}
                  maxLength={500}
                  className="create-post-textarea w-full resize-none border-0 bg-transparent p-0 focus:ring-0 focus:outline-none text-base"
                  style={{ 
