  ...
  if (error) {
    return (
      <div className="bg-destructive/10 border border-destructive/30 rounded-lg p-4">
        <div className="flex">
          <svg className="w-5 h-5 text-destructive mr-3 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div>
            ...
            <button
              onClick={loadPosts}
              className="mt-3 text-sm font-medium text-destructive hover:text-destructive/80"
            >
              Try again
            </button>
          </div>
