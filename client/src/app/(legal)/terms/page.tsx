      ...
      >
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <div className="text-center mb-12">
            ...
            >
              These terms govern your use of ThreadUp. By using our service, you agree to these terms. 
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p 
                  ...
                  style={{ color: 'var(--color-muted-foreground, #64748b)' }}
                >
                  By creating an account or using ThreadUp, you agree to be bound by these Terms of Service 
                  and our Community Guidelines. If you don't agree to these terms, please don't use our service.
                </p>
              </div>
            </div>
          </div>
              ...
              <div>
                ...
                <ul className="space-y-2">
                  <li className="flex items-start space-x-2">
                    ...
                    <span className="text-sm" style={{ color: 'var(--color-muted-foreground, #64748b)' }}>
