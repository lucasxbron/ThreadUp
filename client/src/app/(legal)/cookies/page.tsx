...
export default function CookiePolicyPage() {
  const cookieTypes = [
    ...
    // }
    {
      ...
      description: "Required for basic functionality and security",
      purpose:
        "These cookies are necessary for ThreadUp to function properly and cannot be disabled.",
      examples: [
        "Authentication tokens to keep you logged in",
        "Security tokens to prevent cross-site attacks",
  ...
  const managementOptions = [
    ...
    // },
    {
      title: "Clear Data",
      description:
        "You can delete all cookies at any time through your browser",
      icon: (
        <svg
          className="w-5 h-5"
          fill="none"
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          >
            ...
            <p
              ...
              style={{ color: "var(--color-muted-foreground, #64748b)" }}
            >
              At ThreadUp, we believe in transparency and minimal data
              collection. We only use cookies that are absolutely necessary for
