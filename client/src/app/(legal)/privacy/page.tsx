  ...
  const dataUse = [
    {
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9v-3m0 0a6 6 0 01-5.356-1.857m5.356 1.857a6 6 0 001.732 1.857M3 12h6m-6 0v-3m0 3v3m6-3h3m-3 0v-3m0 3v3" />
        </svg>
      ),
      ...
      >
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <div className="text-center mb-12">
            ...
            >
              We believe in transparency about how we collect, use, and protect your information. 
              This policy explains our privacy practices in simple, clear terms.
            </p>
          </div>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <h3 className="font-semibold mb-2" style={{ color: 'var(--color-foreground, #0f172a)' }}>Transparency</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="font-semibold mb-2" style={{ color: 'var(--color-foreground, #0f172a)' }}>Minimal Collection</h3>
                <p className="text-sm" style={{ color: 'var(--color-muted-foreground, #64748b)' }}>
              ...
              <div className="text-center">
                ...
                <h3 className="font-semibold mb-2" style={{ color: 'var(--color-foreground, #0f172a)' }}>Your Control</h3>
                <p className="text-sm" style={{ color: 'var(--color-muted-foreground, #64748b)' }}>
