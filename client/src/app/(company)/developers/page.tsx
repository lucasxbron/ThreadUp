...
export default function DevelopersPage() {
  ...
  const techStack = [
    ...
    },
    {
      ...
      technologies: [
        ...
        { name: "Email Verification", description: "Account validation system" }
      ]
    },
    {
  ...
  const contributionAreas = [
    ...
    },
    {
      ...
      description: "Work on API endpoints, database optimization, and server logic",
      ...
      >
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <div className="text-center mb-12">
            ...
            >
              ThreadUp is built in the open. Explore our codebase, contribute to development, 
              and help shape the future of privacy-focused social networking.
            </p>
          </div>
              ...
              >
                <div className="flex items-center justify-between mb-6">
                  <div className="flex items-center space-x-3">
                    <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24" style={{ color: 'var(--color-foreground, #0f172a)' }}>
                      <path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"/>
                    </svg>
                    <div>
                      <h2 
                ...
                <p 
                  ...
                  style={{ color: 'var(--color-muted-foreground, #64748b)' }}
                >
                  ThreadUp is completely open source and available on GitHub. You can explore the codebase, 
                  report issues, suggest features, and contribute to development.
                </p>

                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  <div className="text-center p-4 rounded-lg" style={{ backgroundColor: 'var(--color-secondary, #f1f5f9)' }}>
                    <div className="text-2xl font-bold mb-1" style={{ color: 'var(--color-primary, #3b82f6)' }}>MIT</div>
                    <div className="text-sm" style={{ color: 'var(--color-muted-foreground, #64748b)' }}>License</div>
                  </div>
                  <div className="text-center p-4 rounded-lg" style={{ backgroundColor: 'var(--color-secondary, #f1f5f9)' }}>
                    <div className="text-2xl font-bold mb-1" style={{ color: 'var(--color-success, #22c55e)' }}>TypeScript</div>
                    <div className="text-sm" style={{ color: 'var(--color-muted-foreground, #64748b)' }}>Language</div>
                  </div>
                  <div className="text-center p-4 rounded-lg" style={{ backgroundColor: 'var(--color-secondary, #f1f5f9)' }}>
                    <div className="text-2xl font-bold mb-1" style={{ color: 'var(--color-warning, #f59e0b)' }}>v0.1.0</div>
                    <div className="text-sm" style={{ color: 'var(--color-muted-foreground, #64748b)' }}>Version</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-8">
              <div className="text-center mb-8">
                ...
                <p 
                  ...
                  style={{ color: 'var(--color-muted-foreground, #64748b)' }}
                >
                  ThreadUp is built with modern technologies that prioritize performance, 
          ...
          >
            ...
            <p 
              ...
              style={{ color: 'var(--color-muted-foreground, #64748b)' }}
            >
              Join our community of developers and help build the future of privacy-focused social networking.
            </p>
