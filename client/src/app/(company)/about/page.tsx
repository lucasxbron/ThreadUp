  ...
  const values = [
    {
      title: "Privacy First",
      description:
        "We believe your data belongs to you. ThreadUp collects only what's necessary and nothing more.",
      icon: (
        <svg
          className="w-8 h-8"
          fill="none"
    ...
    },
    {
      title: "Open Source",
      description:
        "Complete transparency through open source development. Every line of code is available for inspection.",
      icon: (
    ...
    },
    {
      ...
      description:
        "Built with and for the community. Every feature and decision is guided by user feedback.",
      icon: (
        <svg
          className="w-8 h-8"
          fill="none"
    ...
    },
    {
      title: "Modern & Simple",
      description:
        "Clean, intuitive design that focuses on what matters most - your content and connections.",
      icon: (
        <svg
          className="w-8 h-8"
          fill="none"
  ...
  const features = [
    {
      ...
      description:
        "Create text and image posts to share with your followers. Express yourself authentically.",
      icon: (
        <svg
          className="w-6 h-6"
          fill="none"
    ...
    },
    {
      ...
      description:
        "Follow friends and discover interesting people. Build meaningful connections.",
      icon: (
        <svg
          className="w-6 h-6"
          fill="none"
    ...
    },
    {
      ...
      description:
        "Like, comment, and have conversations. Build community through genuine interaction.",
      icon: (
        <svg
          className="w-6 h-6"
          fill="none"
    ...
    },
    {
      title: "Stay Safe",
      description:
        "Comprehensive safety tools and community guidelines keep ThreadUp a positive space.",
      icon: (
        <svg
          className="w-6 h-6"
          fill="none"
    ...
    },
    {
      ...
      description:
        "Choose the look that's right for you with beautiful light and dark mode themes.",
      icon: (
        <svg
          className="w-6 h-6"
          fill="none"
    ...
    },
    {
      ...
      description:
        "ThreadUp works beautifully on any device, from phones to desktops.",
      icon: (
        <svg
          className="w-6 h-6"
          fill="none"
      ...
      <main className="flex-1 transition-colors duration-300">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <div className="text-center mb-16">
            ...
            >
              ThreadUp is a privacy-first social platform designed to bring
              people together without compromising their personal data. Built in
          ...
          >
            ...
            <p
              ...
              style={{ color: "var(--color-muted-foreground, #64748b)" }}
            >
              To create a social platform that respects user privacy, promotes
              authentic connections, and operates with complete transparency. We
              believe social media should bring out the best in people, not
          ...
          <div className="mb-16">
            ...
            <p
              ...
              style={{ color: "var(--color-muted-foreground, #64748b)" }}
            >
              ThreadUp is built differently from the ground up, prioritizing
              user experience over profit.
            </p>
