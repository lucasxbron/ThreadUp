...
export default function SafetyPage() {
  const safetyFeatures = [
    ...
    },
    {
      ...
      description: "We're committed to protecting your personal information and privacy.",
      features: [
    ...
    },
    {
      ...
      description: "Advanced systems help keep our community safe from harmful content.",
      features: [
      ...
      >
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <div className="text-center mb-12">
            ...
            >
              Your safety is our top priority. We've built comprehensive features and policies to help protect you 
              ...
              >
                <div className="flex items-start space-x-4 mb-4">
                  <div 
                    ...
                    style={{ backgroundColor: 'var(--color-success, #22c55e)', color: 'white' }}
                  >
                    {feature.icon}
                  </div>
                  <div>
          ...
          >
            ...
            <p 
              ...
              style={{ color: 'var(--color-muted-foreground, #64748b)' }}
            >
              If you're experiencing harassment, threats, or any safety concerns, please report it immediately. 
              For emergencies, contact your local authorities.
            </p>
