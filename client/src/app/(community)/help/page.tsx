      ...
      >
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <div className="text-center mb-12">
            ...
            >
              Find answers to common questions and learn how to make the most of ThreadUp.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            {(searchQuery ? filteredArticles : filteredCategories.flatMap(cat => 
              cat.articles.map(article => ({ ...article, categoryTitle: cat.title, categoryIcon: cat.icon }))
            )).map((article, index) => (
              <div
                key={index}
              ...
              >
                <div className="flex items-start space-x-3 mb-4">
                  ...
                  <div className="flex-1">
                    <div className="text-xs font-medium mb-1" style={{ color: 'var(--color-primary, #3b82f6)' }}>
                ...
                <div className="border-t pt-4 mt-4" style={{ borderColor: 'var(--color-border, #e2e8f0)' }}>
                  <div 
