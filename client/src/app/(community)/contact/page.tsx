  ...
  return (
    <>
      ...
      <style jsx global>{`
        ...
        .dark .contact-input, .dark .contact-select, .dark .contact-textarea {
        ...
        .dark .contact-input::placeholder, .dark .contact-textarea::placeholder {
              ...
              <div className="space-y-6">
                ...
                >
                  ...
                  >
                    ...
                    For urgent safety issues, we aim to respond within a few hours.
                  </p>
                </div>
                ...
                >
                  <div className="flex items-center space-x-3 mb-4">
                    <div 
                      className="w-10 h-10 rounded-lg flex items-center justify-center"
                      style={{ backgroundColor: 'var(--color-purple, #a855f7)', color: 'white' }}
                    >
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
