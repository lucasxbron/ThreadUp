...
export default function CommunityGuidelinesPage() {
  const guidelines = [
    {
      ...
      title: "Be Respectful",
      description:
        "Treat everyone with kindness and respect. We're all here to connect and share meaningful experiences.",
      rules: [
    ...
    },
    {
      ...
      title: "Keep It Safe",
      description:
        "ThreadUp should be a safe space for everyone. Help us maintain a secure environment for all users.",
      rules: [
    ...
    },
    {
      ...
      description:
        "Be genuine and honest in your interactions. Authenticity builds trust and meaningful connections.",
      rules: [
    ...
    },
    {
      ...
      title: "No Harassment",
      description:
        "Everyone deserves to feel safe and welcome. Help us create a harassment-free environment.",
      rules: [
    ...
    },
    {
      ...
      description:
        "Respect intellectual property and give credit where it's due. Only share content you have the right to post.",
      rules: [
    ...
    },
    {
      ...
      description:
        "Keep the platform clean and valuable for everyone by avoiding spam and system abuse.",
      rules: [
  ...
  const consequences = [
    ...
    },
    {
      ...
      description:
        "Repeated violations may result in temporary limitations on account features",
    ...
    // },
    {
      level: "Permanent Ban",
      description:
        "Severe or repeated serious violations result in permanent account termination",
      ...
      <main className="flex-1 transition-colors duration-300">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <div className="text-center mb-12">
            ...
            >
              ThreadUp is built on the foundation of respect, authenticity, and
              meaningful connections. These guidelines help us maintain a safe,
              welcoming environment for everyone to share, connect, and grow
              together.
            </p>
          </div>
          ...
          >
            ...
            <p
              ...
              style={{ color: "var(--color-muted-foreground, #64748b)" }}
            >
              We take violations seriously and apply consequences fairly. The
              severity of the action depends on the nature and frequency of the
              violation.
            </p>
